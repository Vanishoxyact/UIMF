    ...
    core:add_listener(
        ...
        function(context)
            ...
            if not existingFrame then
                ...
                squareToggleButton:PositionRelativeTo(toggleButtons, 0, 50); 
                ...
                buttonLogic:PositionRelativeTo(toggleButtons, 0, 50);    
                local incrementButton = TextButton.new("incrementButton", myFrame, "TEXT", "+");
                incrementButton:Resize(50, 310);
                incrementButton:PositionRelativeTo(buttonLogic, 0, 50);
                local decrementButton = TextButton.new("decrementButton", myFrame, "TEXT", "-");
                decrementButton:Resize(50, 310);
